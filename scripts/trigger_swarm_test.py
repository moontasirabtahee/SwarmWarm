...
def main():
    ...
    # Mock databases containing active mailbox nodes across distinct tenants
    mock_db_mailboxes = [
        {
            "id": "mailbox_google_1",
            "user_id": "user_1",
    ...
    print("Registered Simulation Mailbox nodes:")
    ...
    try:
        ...
        matches = generate_daily_swarm_graph(mock_db_mailboxes)
